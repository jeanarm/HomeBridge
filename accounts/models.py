...
class Profile(models.Model):
    ...
    languages = models.JSONField(default=list)  # ["en","fr"]
...
class Block(models.Model):
    blocker = models.ForeignKey("auth.User", on_delete=models.CASCADE, related_name="blocks_made")
    blocked = models.ForeignKey("auth.User", on_delete=models.CASCADE, related_name="blocks_received")
    created_at = models.DateTimeField(auto_now_add=True)
...
class Conversation(models.Model):
    ...
    user_a = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="conversations_as_a")
    user_b = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="conversations_as_b")
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["user_a", "user_b"], name="unique_pair_ordered"),
        ]
